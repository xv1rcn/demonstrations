...
export default function Page() {
    ...
    const traces: Data[] = [
        ...coloredLambdaSegments,
        {
            ...
            mode: 'lines',
            x: [lambdaNm, lambdaNm],
            y: [0, scatteringIntensity(i0, particleN, lambdaNm, 90)],
        ...
        },
        {
            ...
            mode: 'lines',
            x: [thetaDeg, thetaDeg],
            y: [0, scatteringIntensity(i0, particleN, lambdaNm, thetaDeg)],
            line: { color: '#f59e42', width: 2, dash: 'dash' },
            xaxis: 'x2',
            yaxis: 'y2',
            name: '当前观测角',
        ...
        <Plot
            ...
            layout={{
                ...
                annotations: [
                    ...
                    {
                        x: lambdaNm,
                        y: scatteringIntensity(i0, particleN, lambdaNm, 90),
                        xref: 'x',
                        yref: 'y',
                        text: `λ=${lambdaNm} nm`,
                        showarrow: true,
                    ...
                    {
                        x: thetaDeg,
                        y: scatteringIntensity(i0, particleN, lambdaNm, thetaDeg),
                        xref: 'x2',
                        yref: 'y2',
                        text: `θ=${thetaDeg}°`,
                        showarrow: true,
            ...
            hint={{
                ...
                content: (
                    <span>
                        ...
                        波长越短（蓝光）散射越强，波长越长（红光）散射越弱，从原理上解释日常最常见的天空色彩现象。<br />
